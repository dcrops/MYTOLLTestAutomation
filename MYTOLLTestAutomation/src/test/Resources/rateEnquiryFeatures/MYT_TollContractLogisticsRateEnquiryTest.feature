Feature: MYT-XXXX  - Rate Enquiry for Toll Contract Logistics
  Background: 
    Given User is Registered in MyToll and is on Rate Enquiry Page

  @tag1
  Scenario: User Performs Rate Enquiry for Toll Contract Logistics - Service General
    When User selects Toll Carrier
      ...
      | Toll Contract Logistics    |General     |2230899| 10     |   10  |   10   |
      
      
  @tag2
  Scenario: User Gets a Rate Estimate from within a Shipment - Toll Contract Logistics
    When User Completes Module 1 in the Create Shipment Page
      |TollCarrier               |Service |Who Pays |AccountNumber |
      |Toll Contract Logistics   |General |Sender   |100428 |
