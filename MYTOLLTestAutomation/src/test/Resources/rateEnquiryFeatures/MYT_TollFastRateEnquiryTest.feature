Feature: MYT-XXXX  - Rate Enquiry for Toll Fast

  Background: 
    Given User is Registered in MyToll and is on Rate Enquiry Page

  @tag1
  Scenario: User Performs Rate Enquiry for Toll Fast - Service General
    When User selects Toll Carrier
      ...
      | Toll Fast              |General     |2230899| 10     |   10  |   10   |
      
      
  @tag2
  Scenario: User Gets a Rate Estimate from within a Shipment - Toll Fast
    When User Completes Module 1 in the Create Shipment Page
      |TollCarrier           |Service |Who Pays |AccountNumber |
      |Toll Fast             |General |Sender   |100428 |
