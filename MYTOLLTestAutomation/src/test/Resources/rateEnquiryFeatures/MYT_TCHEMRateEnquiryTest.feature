Feature: MYT-XXXX  - Rate Enquiry for TCHEM

  Background: 
    Given User is Registered in MyToll and is on Rate Enquiry Page

  @tag1
  Scenario: User Performs Rate Enquiry for TCHEM - Service General
    When User selects Toll Carrier
      ...
      | TCHEM                  |General     |2230899| 10     |   10  |   10   |
      
      
  @tag2
  Scenario: User Gets a Rate Estimate from within a Shipment - TCHEM
    When User Completes Module 1 in the Create Shipment Page
      |TollCarrier           |Service |Who Pays |AccountNumber |
      |TCHEM                 |General |Sender   |100428 |
