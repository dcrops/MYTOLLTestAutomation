Feature: MYT_6226 Toll Energy Book A Pickup
  ...
  @tag1
  Scenario: User wants to be able to book a pickup for two lines items with Dangerous goods using Toll Energy and Marine
    When User selects Toll Carrier and Account Number
      | TollCarrier            | AccountNumber |
      | Toll Energy and Marine | G28668        |
    ...
    When User enter following input data to Add Item
      ...
      | DG Express | MELALEUCA   | Automation Template |        10 |           6 | MELALEUCA, 6079 |
    ...
    Then User clicks on Review & Book and User be able to see pickup details entered in Review Your Pickup screen
      ...
      | Toll Energy and Marine | G28668        | AccessHQ | 60, Collins Street CDE MELBOURNE VIC 3000 AU | Kate      |    452456876 | 14:45      | 18:00                 | Special Ins          |
  ...
  @tag2
  Scenario: User wants to be able to book a pickup for one line item using Toll Energy and Marine
    When User selects Toll Carrier and Account Number
      | TollCarrier            | AccountNumber |
      | Toll Energy and Marine | G28668        |
    And User selects a existing Sender address from the Sender field
