...
Feature: MYT_6236 Toll Mining Services TAndT Private search, response and view

Background: 
Given A registered user with a Toll Energy account logging in and visits MyToll

Scenario: A registered user wants to be able track the Toll Mining Services shipment 

When User completes a Track and Trace search using a Toll Mining Services Shipment Number/Reference Number
