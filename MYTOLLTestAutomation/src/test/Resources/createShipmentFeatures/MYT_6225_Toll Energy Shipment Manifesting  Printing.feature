Feature: MYT_6225 Toll Energy Shipment, Manifesting and Printing
  ...
  @tag1
  Scenario: User wants to be able to create and print Shipments, Manifests and Labels with one line item in Toll Energy
    ...
    Then User be able to see following Services
      ...
      | General  | Express  | Hotshot  | Courier  | Overnight | Same Day | DG Freight | Dedicated | DG Courier | DG Overnight | DG Same Day | DG Expres | DG Premium |           |
    When User enters shipment overview details as below to create a shipment
      | AccountNumber | Service    | Mode | Whopays | locationIndex | DGContactName | DGContactNumber | SenderEmail                 | ReceiverEmail               | ShipmentRef1 | ShipmentRef2 | DropOffDepot | CollectionDepot |
      |        100428 | DG Freight | Rail | Sender  |             1 | John          |      0142356789 | NNAutomationUser1@gmail.com | NNAutomationUser2@gmail.com |        12345 |       234567 |            1 |               1 |
    ...
    Then User navigates to Shipment Review page and see Overview details as below.
      ...
      | Toll Energy |               |        12345 |       234567 | DG Freight | Rail |
  ...
  @tag1
  Scenario: User wants to be able to create and print Shipments, Manifests and Labels with two line items in Toll Energy
    When User enters shipment overview details as below to create a shipment
      ...
      | Toll Energy |        100428 | DG Freight | Rail | Sender  |             1 | John          |      0142356789 | NNAutomationUser1@gmail.com | NNAutomationUser2@gmail.com |        12345 |       234567 |            1 |               1 |
    When User enters following input data for the line item
      | Item description     | Billing Type    | No of Items | Item Type | Length | Width | Height | TotalCubicVolume | TotalWeight | SenderReference | ReceiverReference |
      | Automation Template1 | General Freight |          10 | Misc      |    100 |   100 |    100 |               50 |         900 | Ref123          | Ref456            |
    When User selects Dangerous Goods as Yes
