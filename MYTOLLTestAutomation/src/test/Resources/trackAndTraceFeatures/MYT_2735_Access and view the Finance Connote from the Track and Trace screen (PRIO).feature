Feature: MYT_2735 Access and view the Finance Connote from the Track and Trace screen (PRIO)

Background: 
GUser in the Track and Trace screen in Mytoll, and I have have full financial access


Scenario: User wants to access and view the Finance Connote from the Track and Trace screen (PRIO)
