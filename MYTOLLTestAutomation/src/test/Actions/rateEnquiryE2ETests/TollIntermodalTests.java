...
public class TollIntermodalTests {
	...
	public void RateEnquiry_TollIntermodal_E2ETest_TID_1052_Service_Refrigeration()
	{
		...
		//RateEnquiryActions.VerifyMessage("Toll Intermodal","Toll Intermodal is a freight transport partner of choice, offering end-to-end road, rail, coastal shipping and wharf cartage services. We have an extensive range of linehaul equipment that enables us to meet our customers� diverse requirements.");
