...
public class BookAPickupTollTasmaniaStepDefinitions {
	...
	public void user_selects_Toll_Carrier_as_TollTasmania_and_select_Account_Number(DataTable bookAPickupTestData) throws Throwable {
	...
	public void user_verify_Toll_Carrier_and_AcountNumber_selected_as_below(DataTable bookAPickupTestData) throws Throwable {
		...
		for (Map<String, String> bookAPickup : bookAPickupTestData.asMaps(String.class,String.class))
		   {
			...
			BookAPickupActions.EnterLengthWidthHeightVolumeWeight(bookAPickup.get("Length"), bookAPickup.get("Width"), bookAPickup.get("Height"),bookAPickup.get("Weight"));
		   }
