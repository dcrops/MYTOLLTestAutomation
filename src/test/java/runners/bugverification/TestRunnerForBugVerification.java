...
@CucumberOptions( strict=true
		...
		"src/test/Resources/bugverification/MYT_9043_Save_template_Minimal_info.feature",

/*		"src/test/Resources/bugverification/MYT_8826_Weights_Change_to_zero_at_print_and_close.feature"
		//passing manually. The only issue is the screen that pops up "add to existing manifest" needs to be fixed for all. */
...
/*		////		"src/test/Resources/bugverification/MYT_6200 BU Admin User cannot see the My Admin Menu.feature"
 		myt-6200 requires the use of admin user. do not include/uncomment it in test runners.*/
